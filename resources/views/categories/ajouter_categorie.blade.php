...
<div class="card">
    <div class="card-body">
        <h2 class="card-title"style="margin-bottom:20px;">Ajouter categorie</h2>
        <form class="forms-sample" action="" method="post" enctype='multipart/form-data' >
            @csrf
            <div class="row mb-3">
                <div class="col">
                    <label for="exampleInputUsername1" class="form-label">Nom:</label>
                    <input type='text'  name='nom_categorie' class="form-control " id="exampleInputUsername1" required>
                </div>
            </div>
