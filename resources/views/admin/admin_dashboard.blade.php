...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('backend/assets/css/message/toastr.css')}}" >
</head>
<body>
  ...
  <script src="{{asset('backend/assets/js/dashboard-dark.js')}}"></script>
	...
	<script type="text/javascript" src="{{asset('backend/assets/js/toatr.js')}}"></script>
...
<script src="{{asset('backend/assets/js/sweetalert.js')}}"></script>
 ...
 <script src="{{asset('backend/assets/vendors/js/script.js')}}"></script>
...
<!-- <script src="{{asset('backend/assets/vendors/js/jquery.js')}}"></script>     -->
